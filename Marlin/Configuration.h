...
#define STRING_CONFIG_H_AUTHOR "(SirTheta, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Michu's Ender-3"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 32.8
  #define DEFAULT_bedKd 239.67
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 76 +  X_PROBE_OFFSET_FROM_EXTRUDER
 //#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - (MIN_PROBE_EDGE))
  #define FRONT_PROBE_BED_POSITION 30 + Y_PROBE_OFFSET_FROM_EXTRUDER
...
#define HOMING_FEEDRATE_Z  (20*40)
